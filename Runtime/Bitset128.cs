...
// manipulated by standard logic operators and converted to and
// from strings and integers.
public unsafe struct Bitset128 : IEquatable<Bitset128> {
    ...
    public ulong ToUInt64() {
        Debug.Assert(w[1] == 0, "Cannot convert to UInt64");
        return w[0];
    }
